...
public class Lab3 {
	...
	public static void main(String[] args) {
		...
		//write and test a method that takes an array of Strings and returns and array of int where each element matches the length of the string
		//at that position
		...
		//write and test a method that takes an array of strings and returns true if the sum of letters for all strings with an even amount of
